...
def connect_to_mongo():
    ...
    try:
        ...
        collections["webhook_events"] = db.get_collection("webhook_events")
        collections["investigations"] = db.get_collection("investigations")
        collections["analytics"] = db.get_collection("analytics")
